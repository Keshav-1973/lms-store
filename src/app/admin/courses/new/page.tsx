...
export default function NewCoursePage() {
  ...
  const handleCourseNameChange = (value: string) => {
    ...
    if (!isSlugManuallyEdited || slug.length === 0) {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-5 py-10 sm:px-8">
      ...
      <h1 className="mb-6 text-2xl font-bold text-slate-900">Add New Course</h1>
      ...
      <form action={formAction} className="space-y-6">
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <Field
              label="Tagline"
              name="tagline"
              placeholder="One-line course pitch"
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <TextareaField
              ...
              name="description"
              rows={3}
              placeholder="2–3 sentence overview shown on the courses list page."
            />
            <TextareaField
              label="Detailed Description"
              name="description_detailed"
              rows={5}
              placeholder="Full description shown on the course detail page."
            />
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Field
              ...
              type="number"
              placeholder="4.9"
              hint="Use 0 to 5. Supports decimals."
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-xs text-slate-400">
            Used for the course card header gradient.
          </p>
        </div>
